...
A modular Telegram Python bot running on python3 with a sqlalchemy database and an entirely themed persona to make Saitama suitable for Group Chats

Can be found on telegram as [SenkuRobot](https://t.me/SenkuRobot).

The Support group can be reached out to at [Spongebob Support](https://t.me/VohaUnion), where you can ask for help about [Spongebob](https://t.me/Spongebobsquarepantsrobot), discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
